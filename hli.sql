...
-- Dumping database structure for hli
CREATE DATABASE IF NOT EXISTS `hli` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `hli`;

-- Dumping structure for table hli.admin
...
-- Dumping data for table hli.guru: ~0 rows (approximately)
DELETE FROM `guru`;

-- Dumping structure for table hli.kelas
...
-- Dumping data for table hli.kelas: ~0 rows (approximately)
DELETE FROM `kelas`;
INSERT INTO `kelas` (`id`, `kelas`, `nama_siswa`) VALUES
	(1, 'Kelas Pemrograman Dasar', '');

-- Dumping structure for table hli.materi
...
-- Dumping data for table hli.materi: ~31 rows (approximately)
DELETE FROM `materi`;
...
-- Dumping structure for table hli.siswa
...
-- Dumping data for table hli.siswa: ~1 rows (approximately)
DELETE FROM `siswa`;
INSERT INTO `siswa` (`id`, `nama`, `password`, `email`, `image`, `is_active`, `date_created`) VALUES
	(47, 'Test Siswa', '$2y$10$ckZUwJ09aTRXoP4Ya0nGmuXwRXBwtlAS6ooK2K5PHWg7/FBOkjV2W', 'siswa@gmail.com', 'default.jpg', 1, 0);

-- Dumping structure for table hli.token
...
-- Dumping data for table hli.token: ~0 rows (approximately)
DELETE FROM `token`;
