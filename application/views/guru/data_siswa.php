            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Siswa Home Learning Indonesia</h2>
                            <hr>
                            <p class="card-text">Jumlah Siswa yang terdaftar di Home Learning Indonesia sekarang adalah
