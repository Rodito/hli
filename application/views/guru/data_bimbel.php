            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data bimbel Home Learning Indonesia Education</h2>
                            <hr>
                            <p class="card-text">Jumlah bimbel yang terdaftar di Home Learning Indonesia Education sekarang adalah
