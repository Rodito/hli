...
<head>
	...
	<title>Admin Dashboard - Home Learning Indonesia</title>
	<!-- General CSS Files -->
			...
			<div class="main-sidebar">
				<aside id="sidebar-wrapper">
					<div class="sidebar-brand text-danger">
						<div>
							<a href="<?= base_url('admin') ?>" style="font-size: 21px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-left"><i style="font-size: 30px;" class="fas fa-book"></i> HLI </a>
						</div>
					</div>
