            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Kelas Home Learning Indonesia</h2>
                            <hr>
                            <p class="card-text">Jumlah Kelas yang ada di Home Learning Indonesia sekarang adalah
