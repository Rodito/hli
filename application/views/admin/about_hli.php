<!--
@Project: Home Learning Indonesia
@Programmer: Syauqi Zaidan Khairan Khalaf
@Website: https://linktr.ee/syauqi
@Email : syaokay@gmail.com

@About-Home Learning Indonesia :
Web Edukasi Open Source yang dibuat oleh Syauqi Zaidan Khairan Khalaf.
Home Learning Indonesia adalah Web edukasi yang dilengkapi video, materi dan sistem ujian
yang tersedia secara gratis. Home Learning Indonesia dibuat ditujukan agar para siswa dan
...
<head>
    ...
    <title>Tentang Developer Home Learning Indonesia</title>
    <!-- General CSS Files -->
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - Home Learning Indonesia</div>
                    ...
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="<?= base_url('admin') ?>" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 30px;" class="fas fa-graduation-cap"></i> |
                                Home Learning Indonesia <sup>3</sup> </a>
                        </div>
                    </div>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project Home Learning Indonesia </h1>
                    </div>
                    <div class="">
                        <video class="afterglow" autoplay id="myvideo" width="1280" height="720">
                            <source type="video/mp4" src="<?= base_url('assets/') ?>Home Learning Indonesia.mp4" />
                        </video>
                    </div>
                    <br>
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang Home Learning Indonesia</h2>
                                <hr>
                                <p class="card-text">Web Edukasi Open Source yang dibuat oleh Syauqi Zaidan Khairan Khalaf. <br> Home Learning Indonesia adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> Home Learning Indonesia dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
                            </div>
                        </div>
                    </div>
                </section>
